...
class VideoPlayerApp:
    def __init__(self, window, video_source):
        ...
        self.submitButton.place(x=580,y=315)
        ...
        self.clearButton.place(x=730, y=315) 
        self.forgotPasswordButton = tk.Button(window, text='forgotPassword', font=('Open Sans', 12, 'bold'), bd=2, bg='black', fg='cyan',cursor='hand2', activebackground='black', activeforeground='cyan', width=14,height=0, command=forgotPass)
